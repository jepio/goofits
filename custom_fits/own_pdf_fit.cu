...
int main (int argc, char** argv) {
  ...
  Variable *p = new Variable("peak",1,0.01,3);
  Variable *w = new Variable("width",1,0.01,3);
  Variable *t = new Variable("tail",0.5,0.01,3);

  Variable *mean = new Variable("mean",-50,-100,0);
  Variable *sL = new Variable("sigma left",10,0,50);
  Variable *sR = new Variable("sigma right",10,0,50);
  Variable *scale = new Variable("scale",1);
